...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\n  background-size: cover;\n  background-position: center;\n  text-align: center;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n}\nbody .main-content {\n  border: 1px solid white;\n}\nbody .footer {\n  align-self: flex-start;\n}\n\n.header {\n  display: flex;\n  flex-direction: column;\n}\n.header h1 {\n  color: #2f4a62;\n}\n.header .instructions-box {\n  align-self: flex-end;\n  width: 400px;\n  display: flex;\n  justify-content: center;\n}\n.header .instructions-box .instructions-button {\n  background-color: #e6cacf;\n  color: #2f4a62;\n  width: fit-content;\n  border: 2px outset #e6cacf;\n  padding: 5px;\n  border-radius: 5px;\n}\n\n.board-container {\n  background-color: #5481bd;\n  border-radius: 20%;\n  width: fit-content;\n  padding: 0 50px;\n  margin: 0 auto;\n  min-height: 300px;\n  display: flex;\n  align-items: center;\n}\n.board-container .board {\n  width: fit-content;\n  margin: 0 auto;\n  position: relative;\n  text-align: center;\n}\n.board-container .board .topNums {\n  color: aquamarine;\n  position: relative;\n  display: flex;\n  top: 0;\n  border: 2px solid transparent;\n}\n.board-container .board .topNums > div {\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-end;\n  width: 15px;\n  padding: 0 5px;\n  border: 1px solid transparent;\n}\n.board-container .board .leftNums {\n  left: -30px;\n  color: aquamarine;\n  position: absolute;\n  display: flex;\n  flex-direction: column;\n  border: 2px solid transparent;\n}\n.board-container .board .leftNums > div {\n  display: flex;\n  justify-content: flex-end;\n  align-items: center;\n  height: 25px;\n  border: 1px solid transparent;\n}\n.board-container .board .grid {\n  border: 2px solid black;\n}\n.board-container .board .grid .row-div {\n  display: flex;\n}\n.board-container .board .grid .row-div .square {\n  width: 25px;\n  height: 25px;\n  border: 1px outset black;\n}\n.board-container .board .grid .row-div .unclicked {\n  background-color: aquamarine;\n}\n.board-container .board .grid .row-div .filled {\n  background-color: teal;\n}\n.board-container .board .grid .row-div .exed {\n  background-color: red;\n}\n.board-container .board .grid .row-div .maybe {\n  background-color: pink;\n}\n\n.message-box {\n  color: whitesmoke;\n  border: 1px solid whitesmoke;\n  width: 300px;\n  height: 100px;\n  margin: 0 auto;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}", "",{"version":3,"sources":["webpack://./main.scss","webpack://./index.scss","webpack://./components/header.scss","webpack://./colors.scss","webpack://./components/grid.scss","webpack://./components/message_box.scss"],"names":[],"mappings":"AAAA;EACI,yDAAA;EACA,sBAAA;EACA,2BAAA;EACA,kBAAA;EACA,aAAA;EACA,sBAAA;EACA,8BAAA;ACCJ;ADCI;EACI,uBAAA;ACCR;ADCI;EACI,sBAAA;ACCR;;ACdA;EACI,aAAA;EACA,sBAAA;ADiBJ;AChBI;EACI,cCJC;AFsBT;AChBI;EACI,oBAAA;EACA,YAAA;EAEA,aAAA;EACA,uBAAA;ADiBR;AChBQ;EACI,yBCXC;EDYD,cCdH;EDeG,kBAAA;EACA,0BAAA;EACA,YAAA;EACA,kBAAA;ADkBZ;;AGpCA;EACI,yBAAA;EACA,kBAAA;EACA,kBAAA;EACA,eAAA;EACA,cAAA;EACA,iBAAA;EACA,aAAA;EACA,mBAAA;AHuCJ;AGtCI;EACI,kBAAA;EACA,cAAA;EACA,kBAAA;EACA,kBAAA;AHwCR;AGvCQ;EACI,iBAAA;EACA,kBAAA;EACA,aAAA;EACA,MAAA;EACA,6BAAA;AHyCZ;AGvCY;EACI,aAAA;EACA,sBAAA;EACA,yBAAA;EACA,WAAA;EACA,cAAA;EAEA,6BAAA;AHwChB;AGrCQ;EACI,WAAA;EACA,iBAAA;EACA,kBAAA;EACA,aAAA;EACA,sBAAA;EACA,6BAAA;AHuCZ;AGtCY;EACI,aAAA;EACA,yBAAA;EACA,mBAAA;EACA,YAAA;EACA,6BAAA;AHwChB;AGrCQ;EACI,uBAAA;AHuCZ;AGtCY;EACI,aAAA;AHwChB;AGvCgB;EACI,WAAA;EACA,YAAA;EACA,wBAAA;AHyCpB;AGvCgB;EACI,4BAAA;AHyCpB;AGvCgB;EACI,sBAAA;AHyCpB;AGvCgB;EACI,qBAAA;AHyCpB;AGvCgB;EACI,sBAAA;AHyCpB;;AI1GA;EACI,iBAAA;EACA,4BAAA;EACA,YAAA;EACA,aAAA;EACA,cAAA;EACA,aAAA;EACA,sBAAA;EACA,mBAAA;AJ6GJ","sourcesContent":["body {\n    background-image: url(../images/mountain.jpg);\n    background-size: cover;\n    background-position: center;\n    text-align: center;\n    display: flex;\n    flex-direction: column;\n    justify-content: space-between;\n\n    .main-content {\n        border: 1px solid white;\n    }\n    .footer {\n        align-self: flex-start;\n    }\n}\n","body {\n  background-image: url(../images/mountain.jpg);\n  background-size: cover;\n  background-position: center;\n  text-align: center;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n}\nbody .main-content {\n  border: 1px solid white;\n}\nbody .footer {\n  align-self: flex-start;\n}\n\n.header {\n  display: flex;\n  flex-direction: column;\n}\n.header h1 {\n  color: #2f4a62;\n}\n.header .instructions-box {\n  align-self: flex-end;\n  width: 400px;\n  display: flex;\n  justify-content: center;\n}\n.header .instructions-box .instructions-button {\n  background-color: #e6cacf;\n  color: #2f4a62;\n  width: fit-content;\n  border: 2px outset #e6cacf;\n  padding: 5px;\n  border-radius: 5px;\n}\n\n.board-container {\n  background-color: #5481bd;\n  border-radius: 20%;\n  width: fit-content;\n  padding: 0 50px;\n  margin: 0 auto;\n  min-height: 300px;\n  display: flex;\n  align-items: center;\n}\n.board-container .board {\n  width: fit-content;\n  margin: 0 auto;\n  position: relative;\n  text-align: center;\n}\n.board-container .board .topNums {\n  color: aquamarine;\n  position: relative;\n  display: flex;\n  top: 0;\n  border: 2px solid transparent;\n}\n.board-container .board .topNums > div {\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-end;\n  width: 15px;\n  padding: 0 5px;\n  border: 1px solid transparent;\n}\n.board-container .board .leftNums {\n  left: -30px;\n  color: aquamarine;\n  position: absolute;\n  display: flex;\n  flex-direction: column;\n  border: 2px solid transparent;\n}\n.board-container .board .leftNums > div {\n  display: flex;\n  justify-content: flex-end;\n  align-items: center;\n  height: 25px;\n  border: 1px solid transparent;\n}\n.board-container .board .grid {\n  border: 2px solid black;\n}\n.board-container .board .grid .row-div {\n  display: flex;\n}\n.board-container .board .grid .row-div .square {\n  width: 25px;\n  height: 25px;\n  border: 1px outset black;\n}\n.board-container .board .grid .row-div .unclicked {\n  background-color: aquamarine;\n}\n.board-container .board .grid .row-div .filled {\n  background-color: teal;\n}\n.board-container .board .grid .row-div .exed {\n  background-color: red;\n}\n.board-container .board .grid .row-div .maybe {\n  background-color: pink;\n}\n\n.message-box {\n  color: whitesmoke;\n  border: 1px solid whitesmoke;\n  width: 300px;\n  height: 100px;\n  margin: 0 auto;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}",".header {\n    display: flex;\n    flex-direction: column;\n    h1 {\n        color: $header;\n    }\n    .instructions-box {\n        align-self: flex-end;\n        width: 400px;\n\n        display: flex;\n        justify-content: center;\n        .instructions-button {\n            background-color: $cloud-pink;\n            color: $header;\n            width: fit-content;\n            border: 2px outset $cloud-pink;\n            padding: 5px;\n            border-radius: 5px;\n        }\n    }\n}\n","$header: rgb(47, 74, 98);\n$mountain-blue: rgb(84, 129, 189);\n$cloud-pink: rgb(230, 202, 207);\n",".board-container {\n    background-color: $mountain-blue;\n    border-radius: 20%;\n    width: fit-content;\n    padding: 0 50px;\n    margin: 0 auto;\n    min-height: 300px;\n    display: flex;\n    align-items: center;\n    .board {\n        width: fit-content;\n        margin: 0 auto;\n        position: relative;\n        text-align: center;\n        .topNums {\n            color: aquamarine;\n            position: relative;\n            display: flex;\n            top: 0;\n            border: 2px solid transparent;\n\n            > div {\n                display: flex;\n                flex-direction: column;\n                justify-content: flex-end;\n                width: 15px;\n                padding: 0 5px;\n\n                border: 1px solid transparent;\n            }\n        }\n        .leftNums {\n            left: -30px;\n            color: aquamarine;\n            position: absolute;\n            display: flex;\n            flex-direction: column;\n            border: 2px solid transparent;\n            > div {\n                display: flex;\n                justify-content: flex-end;\n                align-items: center;\n                height: 25px;\n                border: 1px solid transparent;\n            }\n        }\n        .grid {\n            border: 2px solid black;\n            .row-div {\n                display: flex;\n                .square {\n                    width: 25px;\n                    height: 25px;\n                    border: 1px outset black;\n                }\n                .unclicked {\n                    background-color: aquamarine;\n                }\n                .filled {\n                    background-color: teal;\n                }\n                .exed {\n                    background-color: red;\n                }\n                .maybe {\n                    background-color: pink;\n                }\n            }\n        }\n    }\n}\n",".message-box {\n    color: whitesmoke;\n    border: 1px solid whitesmoke;\n    width: 300px;\n    height: 100px;\n    margin: 0 auto;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n\n    #level-msg {\n    }\n    #game-over-msg {\n    }\n}\n"],"sourceRoot":""}]);
// Exports
